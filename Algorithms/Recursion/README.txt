...
Language: [python]
-------------------------------------
Running command: python knapsack.py
		 python shopping.py
-------------------------------------
...
How to run a code:
	...
	6. type python "name of the file".py and it can be run directly. For example: python knapsack.py
